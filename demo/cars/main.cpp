...
int main(int argc, char *argv[]) {
  ...
  SDL_Window *window =
      SDL_CreateWindow("sdl2-gdk: cars (collision demo)", 0, 0, win_w,
  ...
  sc_game.addCollideSprite({&cs_player, &cs_car_left, &cs_car_right, &cs_car_top, &cs_car_bottom, &cs_car_center});
