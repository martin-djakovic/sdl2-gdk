...
alias g++=/usr/local/Cellar/gcc/15.1.0/bin/g++-15
g++ -dynamiclib -I/usr/local/include/ -fPIC -O2 -o libgdk.dylib src/*.cpp -framework OpenGL -lSDL2 -lSDL2_image -lSDL2_ttf -lSDL2_mixer
